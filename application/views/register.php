...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav mx-auto">
                ...
                <a class="nav-item nav-link active" href="">Be A Space Ranger <span class="sr-only">(current)</span></a>
            </div>
        </div>
    </nav>
    <!-- Form -->
    ...
    <div class="container">  
    <p class="title-regis">Welcome Guest!</p>  
        <div class="row">   
            <div class="col-lg-6">     
                <form class="register" action="<?php echo site_url();?>/model/register">
                    <div class="form-group">
                        <label for="nama">Name</label>
                        <input type="text" class="form-control" id="nama" placeholder="Name">
                    </div>
                    <div class="form-group">
                        <label for="tinggibadan">Email</label>
            ...
            <div class="col-lg-6">
                <img class="img-fluid register" src="<?php echo base_url();?>images/char/spaceranger.png">
            </div>
        </div> 
    </div>
