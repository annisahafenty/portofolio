...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav mx-auto">
                ...
                <a class="nav-item nav-link" href="<?php echo site_url();?>/character">Characters</a>
    ...
    <!-- Video -->
    <div class="vc_empty_space" style="height: 35px"><span class="vc_empty_space_inner"></span></div> <!--Untuk space-->
    <iframe width="715" height="402" src="https://www.youtube.com/embed/EyGuBM1ELf4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    <!-- Foto Index -->
    <div class="vc_empty_space" style="height: 35px"><span class="vc_empty_space_inner"></span></div> <!--Untuk space-->
    <img class="index" src="<?php echo base_url();?>images/home.JPG">
    <div class="vc_empty_space" style="height: 50px"><span class="vc_empty_space_inner"></span></div> <!--Untuk space-->
    <!-- Social Media -->
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col-lg2">                
            <a href="https://linkedin.com/in/annisahafenty" target="_blank"><img class="socialmedia" src="<?php echo base_url();?>images/icon/linkedin.png"></a>
            </div>
            <div class="col-auto">
            <a href="https://www.behance.net/annisahafeb0e4" target="_blank"><img class="socialmedia" src="<?php echo base_url();?>images/icon/behance.png"></a>
            </div>
            <div class="col-lg2">
                <a href="https://www.instagram.com/annisahafenty/" target="_blank"><img class="socialmedia" src="<?php echo base_url();?>images/icon/instagram.png"></a>
            </div>
        </div>
    </div>    
    <div class="vc_empty_space" style="height: 50px"><span class="vc_empty_space_inner"></span></div> <!--Untuk space-->
